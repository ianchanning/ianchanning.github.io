...
var $author$project$Main$clock = A2(
	$elm$html$Html$form,
	_List_Nil,
	_List_fromArray(
		[
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$type_('text'),
											$elm$html$Html$Attributes$value('00'),
	...
	return {
		au: _List_fromArray(
			[
				...
				_List_fromArray(
					[$author$project$Main$tabs, $author$project$Main$clock])),
		...
		aO: 'Lock Stock Pomodoros : ianchanning'
	};
};
var $author$project$Main$main = $elm$browser$Browser$document(
	{aB: $author$project$Main$init, aM: $author$project$Main$subscriptions, aP: $author$project$Main$update, aQ: $author$project$Main$view});
